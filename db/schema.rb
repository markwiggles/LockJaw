...
ActiveRecord::Schema.define(version: 20141019213316) do
  ...
  create_table "admin_buymsgs", force: true do |t|
    t.string  "message"
  ...
  create_table "admin_buyposters", force: true do |t|
    t.string  "image_id"
    t.string  "image_url"
    t.string  "link"
    t.integer "position"
  ...
  create_table "admin_hows", force: true do |t|
    ...
    t.string   "image_position"
    t.string   "image_id"
    t.string   "image_id_color"
    t.string   "image_url_color"
  end
  ...
  create_table "admin_social_media", force: true do |t|
    t.string  "image_id"
    t.string  "image_url"
    t.string  "link"
    t.integer "position"
